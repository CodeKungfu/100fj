---
name: "supermarkets"
description: "Find nearby supermarkets. Invoke when user asks for grocery stores near me."
---

# Nearby Supermarkets

用途
- 提供用户当前位置附近的 Supermarkets 列表
- 统一返回字段与查询行为，便于前端/接口复用

触发条件
- 用户询问“超市 附近 / supermarkets near me / nearby grocery”

输入参数
- location: 经纬度 { lat, lng }，必填
- radius_meters: 查询半径，默认 3000
- limit: 返回数量上限，默认 20，最大 50
- filters: 可选筛选（是否24小时、评分、连锁品牌等）

响应字段
- 统一参见 [STANDARD_RESPONSE.md](file:///Users/mac_lkm/workspace/trae/100fj/.trae/skills/STANDARD_RESPONSE.md)
- 本技能 category 固定为 "supermarkets"
