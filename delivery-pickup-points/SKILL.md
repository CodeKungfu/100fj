...
# Nearby Delivery Pickup Points

用途
- 提供用户当前位置附近的 Parcel/Delivery Pickup Points 列表
- 统一返回字段与查询行为，便于前端/接口复用

触发条件
- 用户询问“快递自提点 附近 / pickup points near me / parcel pickup”

输入参数
- location: 经纬度 { lat, lng }，必填
- radius_meters: 查询半径，默认 3000
- limit: 返回数量上限，默认 20，最大 50
- filters: 可选筛选（是否24小时、是否智能柜等）

响应字段
- 统一参见 [STANDARD_RESPONSE.md](file:///Users/mac_lkm/workspace/trae/100fj/.trae/skills/STANDARD_RESPONSE.md)
- 本技能 category 固定为 "delivery-pickup-points"
