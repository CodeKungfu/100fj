...
用途
- 提供用户当前位置附近的 EV Charging Stations 列表
- 统一返回字段与查询行为，便于前端/接口复用

触发条件
- 用户询问“充电站 附近 / EV charging stations near me / charging near me”

输入参数
- location: 经纬度 { lat, lng }，必填
- radius_meters: 查询半径，默认 4000
- limit: 返回数量上限，默认 20，最大 50
- filters: 可选筛选（枪口类型、功率、是否空闲、是否24小时等）

响应字段
- 统一参见 [STANDARD_RESPONSE.md](file:///Users/mac_lkm/workspace/trae/100fj/.trae/skills/STANDARD_RESPONSE.md)
- 本技能 category 固定为 "ev-charging-stations"
...
示例
- 输入: { location: { lat: 30.123, lng: 120.456 }, radius_meters: 3500, limit: 10, filters: { power_kw_min: 60 } }
