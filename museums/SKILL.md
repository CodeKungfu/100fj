---
name: "附近博物馆"
description: "Find nearby museums. Invoke when user asks for museums near me."
---

# Nearby Museums

用途
- 提供用户当前位置附近的 Museums 列表
- 统一返回字段与查询行为，便于前端/接口复用

触发条件
- 用户询问“博物馆 附近 / museums near me / nearby museums”
